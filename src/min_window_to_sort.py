...
def main():
    ...
    if left_bound is None:
        return [-1, -1]
    subarray_min, subarray_max = get_min_max_of_subarray(test_case, left_bound, right_bound)
    left_bound_final, right_bound_final = expand_bounds(test_case, left_bound, right_bound, subarray_min, subarray_max)
